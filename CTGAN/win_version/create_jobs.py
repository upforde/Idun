...
def make_text(output, dataset, matches, decimate, size=None):
    script_path = r"C:\Users\aleks\Desktop\Master Thesis\Idun\CTGAN\CTGAN_training.py"
    python_line = f"py \"{script_path}\" --dataset=\"{dataset}\" --matches={matches} --decimate={decimate}"
...
jobs_dir = r'C:\Users\aleks\Desktop\Master Thesis\Idun\CTGAN\jobs' + os.sep
